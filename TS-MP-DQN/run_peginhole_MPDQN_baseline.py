...
@click.option('--episodes', default=40000, help='Number of epsiodes.', type=int)
...
@click.option('--title', default="Baseline_square_peg", help="Prefix of output files", type=str)
...
def run(seed, episodes, evaluation_episodes, batch_size, gamma, inverting_gradients, initial_memory_threshold,
        ...
        save_freq, save_dir, save_frames, visualise, action_input_layer, title, with_warm_start):
    ...
    env = gym.make('peginhole_3prms-v2')
    ...
    from agents.mpdqn_3prms_baseline import PDQNAgent_Threshold
